...
class GlobalValuesWorker{
    ...
    private var completion: ((Result<GlobalModel?,  CriptocurrenciesError>) -> Void)?
    ...
    func doFetchGlobalValues(completion: @escaping ((Result<GlobalModel?,  CriptocurrenciesError>) -> Void)){
